...
function SignIn() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || "Login failed. Check network link.";
  ...
  const handleGoogleLogin = async () => {
    toast.info("Starting Google login...");
    ...
    try {
      ...
      // After sign-out, we use the clerkInstance directly or the client
      const target = clerkInstance.client?.signIn || clerkInstance;
      ...
      if (target && typeof target.authenticateWithRedirect === 'function') {
      ...
      } else if (signIn && typeof signIn.sso === 'function') {
        ...
        toast.error("Could not find a valid Clerk sign-in method.");
      }
    } catch (error) {
